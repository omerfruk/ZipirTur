...
<div id="carouselExampleControls" class="carousel slide "  data-ride="carousel">
  <div class="carousel-inner" style="height:800px !important;" >
     ...
     <div class="carousel-item">
       <img src="img/antalya/antalya1.jpg" class="d-block" style="width: 100%;" alt="...">
     </div>
     <div class="carousel-item">
       <img src="img/madrid/madrid2.jpg" class="d-block" style="width: 100%;" alt="...">
     </div>
  </div>
...
<div class="container">
  <div class="row">
    ...
    <p class="text-center">Mardin ilinde tarihin çok eski dönemine uzanan dönemlere ait bulgular yer almaktadır.
      ...
      <div class="col-md-12 m-3">
        <img src="img/madrid/madrid1.jpg"class="border ml-3 img-thumbnail rounded float-right"width="300" height="300"/>
         <h3 class="text-center">Madrid</h3><br><h4 class="text-center">Zengin Tarih</h4>
      <p class="text-center">  Zengin tarihi mirasının yanı sıra canlı bir kültür ve sanat merkezi olarak da önem taşır.
        ...
        <div class="col-md-12 m-3">
          <img src="img/antalya/antalya1.jpg"class="border mr-5 img-thumbnail rounded float-left"width="300" height="300"/>
           <h3 class="text-center">Antalya</h3><br><h4 class="text-center">Turizimin Gözde Çiçeğii</h4>
        ...
        <div class="col-md-12 m-3">
          <img src="img/hollywood/hollywood1.jpg"class="border ml-3 img-thumbnail rounded float-right" width="300" height="300"/>
           <h3 class="text-center">HollyWood</h3><br><h4 class="text-center">Filmin Doğası</h4>
          <p class="text-center"> ABD'de yapılan ilk filmler New York kenti civarında çekilmişti. 1900 yıllarına doğru Kaliforniya'da ilk filmler yapılmaya başlandı.
        ...
        <div class="col-md-12 m-3">
          <img src="img/paris/paris2.jpg"class="border mr-5 img-thumbnail rounded float-left" width="300" height="300"/>
      ...
      <!--
      <div class="col-md-12 m-3">
        <img src="img/efes.jpg"class="border ml-3 img-thumbnail rounded float-right"width="300" height="300"/>
         <h3 class="text-center">Mardin</h3><br><h4 class="text-center">Dinlerin ve Dillerin Şehri</h4>
        <p class="text-center">  Ahmet Bey, küçük, ahşap, kırmızı boyalı, iki katlı bir evde otururdu. Erkenden kalkar,
