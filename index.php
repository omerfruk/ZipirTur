    ...
    <p class="text-center">Mardin ilinde tarihin çok eski dönemine uzanan dönemlere ait bulgular yer almaktadır.
      ...
      <div class="col-md-12 m-3">
        <img src="img/madrid/madrid1.jpg"class="border ml-3 img-thumbnail rounded float-right"width="300" height="300"/>
         <h5 class="text-center">Madrid</h5><h5 class="text-center">Zengin Tarih</h5>
      <p class="text-center">  Zengin tarihi mirasının yanı sıra canlı bir kültür ve sanat merkezi olarak da önem taşır.
        ...
        <div class="col-md-12 m-3">
          <img src="img/antalya/antalya1.jpg"class="border mr-5 img-thumbnail rounded float-left"width="300" height="300"/>
           <h5 class="text-center">Antalya</h5><h5 class="text-center">Turizimin Gözde Çiçeğii</h5>
        ...
        <div class="col-md-12 m-3">
          <img src="img/hollywood/hollywood1.jpg"class="border ml-3 img-thumbnail rounded float-right" width="300" height="300"/>
           <h5 class="text-center">HollyWood</h5><h5 class="text-center">Filmin Doğası</h5>
        ...
        <div class="col-md-12 m-3">
          <img src="img/paris/paris2.jpg"class="border mr-5 img-thumbnail rounded float-left" width="300" height="300"/>
           <h5 class="text-center">Paris</h5><h5 class="text-center">Sanatın Merkezi</h5>
